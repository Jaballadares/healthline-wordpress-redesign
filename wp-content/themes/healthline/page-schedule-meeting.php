...
<div class="row salesTime" style="margin:0;">
    <div class="span12">
      ...
      <div class="span6 form-template" id="myForm">
        <form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST" novalidate="novalidate" id="datePicker" class="form-scheduler">
            ...
            <input type="text" name="last_name" placeholder="Last Name" class="sudoPicker" id="last_name" required/>

            <input type="text" name="Get_In_Contact_Date__c" class="picker fa fa-calendar" style="color: #706259; font-family:'proxima-nova';"  placeholder="Preferred Day" id="calendar" required />


            <input type="text" name="Get_In_Contact_Time__c" class="timepicker" id="clock" placeholder="Preferred Time" style="color:#706259; font-family:'proxima-nova';" required/>
            ...
            <div class="checkBox-wrapper">
                ...
                <div class="wrappingEmail">
                    ...
                    <input type="checkbox" id="choice-contact-phone" id="choice-contact-phone" onchange="onCheck(this)"/>

                    <label for="choice-contact-phone" class="phoneChoice" id="label-phone">Phone</label>
                    <input type="text" id="want-phone" placeholder="Please Provide Your Phone #" name="phone">
                     <input type="text" name="Preferred_Method_of_Contact__c" style="background:pink; display: none;" id="preferred-method">
                </div>
            </div>
