...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <div class="container">
    ...
    <div class="row">
      <nav class="nav-main nav-scroll span12" role="navigation">

        <h1>
          <img src="<?php bloginfo('template_directory'); ?>/library/img/structure/healthline-plus.png" alt="Healthline" width="322" height="67">
        </h1>

        <a href="#form-section" class="btn btn-blue">Get Started</a>
